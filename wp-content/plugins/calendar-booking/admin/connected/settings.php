		...
		<div class="twocolumns">
			...
			<aside id="sidebar">
				...
				<ul class="sub-nav">
					...
					<li <?php if ( isset( $_GET['nav'] ) && $_GET['nav'] === 'cbsb-users' || !isset( $_GET['nav'] ) ) { ?>class="active"<?php } ?>><a href="?page=cbsb-settings&nav=cbsb-users"><?php _e( 'Users', 'calendar-booking' ); ?></a></li>
				</ul>
			</aside>
		</div>
